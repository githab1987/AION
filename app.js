...
(function SPECIAL_ALI_UI_RECOVERY () {
  ...
  const TEXT = {
    ...
    en: {
      workspace: "Workspace",
      upload: "Upload Data",
      welcome: "I’m ready. What shall we do this time?",
      workspaceDescription:
  ...
  function currentText() {
    return TEXT[UI.language] || TEXT.id;
  }
  ...
  function renderLanguageSelector() {
    ...
    selector.className =
      "special-ali-language-selector";

    selector.innerHTML = `
      <span class="special-ali-language-label">
        ${currentText().language}
      </span>

      <button
        type="button"
        class="special-ali-language-button ${UI.language === "id" ? "active" : ""}"
        data-ali-language="id"
      >
        Indonesia
      </button>

      <span class="special-ali-language-divider">/</span>

      <button
        type="button"
        class="special-ali-language-button ${UI.language === "en" ? "active" : ""}"
        data-ali-language="en"
      >
        English
      </button>
    `;
  ...
  function renderWelcomeLayer() {
    ...
    layer.innerHTML = `
      ...
      <div class="special-ali-welcome-inner">

        <div class="special-ali-welcome-message">
          ${text.welcome}
        </div>

        <div class="special-ali-shortcuts">

          <button
            type="button"
            class="special-ali-shortcut"
            data-ali-route="workspace"
          >
            <span class="special-ali-shortcut-icon">
              ▦
            </span>

            <span class="special-ali-shortcut-copy">
              <strong>
                ${text.workspace}
              </strong>
        ...
        function (button) {
          ...
          button.addEventListener(
            ...
            function () {
              ...
              const route =
                button.dataset.aliRoute;

              /*
                Use the existing application
                navigation function.

                We do NOT replace or wrap navigate().
              */
              ...
              /*
                Fallback only if navigate()
                is not globally exposed.
              */
  ...
  function ensurePostSignInUI() {

    /*
      Do not create a second application shell.
      We only add the recovery layer when
      the real app shell already exists.
    */
    ...
    /*
      Keep the language/shortcut layer alive
      after existing application rendering.
    */
  ...
  function ensureOCRIconGuard() {

    if (
      document.querySelector(
        "#specialAliOCRIconGuard"
      )
    ) {
      return;
    }
    ...
    style.textContent = `
      ...
      /*
        OCR icon must never become
        an oversized visual element.
      */

      .nav-item[data-route="ocr"] .nav-icon,
      [data-route="ocr"] .nav-icon,
      .ocr-icon,
      .upload-symbol.ocr-icon {
  ...
  function start() {
    ...
    /*
      If user is already signed in and
      the app shell already exists.
    */
  ...
  /*
    Start after the existing application has
    initialized its own DOM.
  */
